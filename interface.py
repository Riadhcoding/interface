...
if choose == '2':
    ...
    os.system('cd $HOME;cd interface/log;cp bash.bashrc /data/data/com.termux/files/usr/etc;termux-reload-settings')
    os.system('clear')
    print(logo0)
    jalan("\033[1;36mDone")
    time.sleep(0.5)
...
########################################################
    ...
    os.system('cd $HOME;cd login/original ;cp bash.bashrc /data/data/com.termux/files/usr/etc;termux-reload-settings')
    os.system('clear')
    print(logo0)
    print("\033[1;36mDone")
    time.sleep(0.5)
